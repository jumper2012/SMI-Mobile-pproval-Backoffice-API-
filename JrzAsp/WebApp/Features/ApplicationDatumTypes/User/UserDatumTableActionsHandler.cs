...
namespace WebApp.Features.ApplicationDatumTypes.User {
    public class UserDatumTableActionsHandler : BaseDatumTableActionsHandler<ApplicationUser> {

        public override decimal Priority => 0;

        public override VueActionTrigger[] TableActionsForSingleContent(ApplicationUser datum,
            ProtoCmsRuntimeContext cmsContext,
            Type datumType) {
            var dtt = datumType.GetDatumTypeFromType<ApplicationUser>();
                ...
                trigs.Add(
                    new VueButton {
                        ...
                        OnClick = $"protoCms.utils.popupEntityOperationForm('datum', '{datum.Id}', '{dtt.Id}', " +
                                  ...
                                  $"'Update {datum.UserName}', '{dtt.Name}')"
                    });
            }
                ...
                trigs.Add(
                    new VueButton {
                        ...
                        OnClick = $"protoCms.utils.popupEntityOperationForm('datum', '{datum.Id}', '{dtt.Id}', " +
                                  ...
                                  $"'Delete {datum.UserName}', '{dtt.Name}')"
                    });
            }
